...
/**
 * EMail is a simple wrapper for the PHPMailer library.
 * @see http://phpmailer.codeworxtech.com/index.php?pg=phpmailer
 *
 * @author MetaYii
 * @package application.extensions.email
 * @since 1.0
 */
class EMail
{
   ...
   public function setPathLayouts($value)
   {
      if (!is_string($value) && !preg_match("/[a-z0-9\.]/i"))
         throw new CException(Yii::t('EMail', 'pathLayouts must be a Yii alias path'));
   ...
   {
      if (!is_string($value) && !preg_match("/[a-z0-9\.]/i"))
         throw new CException(Yii::t('EMail', 'pathViews must be a Yii alias path'));
    ...
    */
	public function __call($method, $params)
	{
		...
		else throw new CException(Yii::t('EMail', 'Can not call a method of a non existent object'));
	}
    ...
    */
	public function __set($name, $value)
	{
	   ...
	   else throw new CException(Yii::t('EMail', 'Can not set a property of a non existent object'));
	}
