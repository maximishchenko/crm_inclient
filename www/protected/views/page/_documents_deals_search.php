    ...
    <div class="box-gray__body">
        <div class="box-gray__form">
            ...
            <div class="form-group">
                <?php echo $form->textField($documents, 'keyword', array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Поиск файлов')); ?>
            </div>
            ...
            <div class="form-group">
                <div class="form-group form-group-btn">
                    <?php echo CHtml::hiddenField('DealsFiles[search]', 'true'); ?>
