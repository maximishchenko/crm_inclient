        ...
        <div class="box-gray__form">
            ...
            <div class="form-group">
                ...
                if ($deals->responsable_id == Yii::app()->user->id) {
                    ...
                    $IamResponsible = true;
                } elseif ($deals->responsable_id == 'no') {
                    $selected_option = array('no' => array('selected' => true));
                } elseif ($deals->responsable_id == $user->parent_id) {
                ...
                if (is_numeric($deals->responsable_id) && $deals->responsable_id != 0) {
            ...
            <div class="access-options access-tab" id="director" <?php echo $directors_block_to_display ?>>
                <?php if (count($directors) > 0) {
                    echo $form->dropDownList($deals, 'director_id', CHtml::listData($directors, 'id', 'first_name'), array('options' => is_numeric($deals->responsable_id) && $deals->responsable_id != 0 ? array($deals->responsable_id => array('selected' => true)) : '', 'class' => 'styled'));
                }
                ?>
            </div>
            <div class="access-options access-tab" id="manager" <?php echo $managers_block_to_display ?>>
                <?php echo $form->dropDownList($deals, 'manager_id', CHtml::listData($managers, 'id', 'first_name'), array('options' => is_numeric($deals->responsable_id) && $deals->responsable_id != 0 ? array($deals->responsable_id => array('selected' => true)) : '', 'class' => 'styled')); ?>
            </div>
            <div class="form-group">
