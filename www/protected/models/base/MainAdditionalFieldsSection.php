 ...
 */
class MainAdditionalFieldsSection extends CActiveRecord
{
	/**
    ...
    public function rules()
    {
        ...
        return array(
            array('name, access', 'required'),
            array('access, weight', 'numerical', 'integerOnly'=>true),
            array('name, group_users', 'length', 'max'=>255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, name, access, group_users, weight', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('group_users',$this->group_users,true);
