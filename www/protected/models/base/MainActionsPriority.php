 ...
 */
class MainActionsPriority extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'actions' => array(self::HAS_MANY, 'Actions', 'action_priority_id'),
		);
	}
	 ...
	 * @return MainActionsPriority the static model class
	 */
