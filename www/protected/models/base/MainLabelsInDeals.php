 ...
 */
class MainLabelsInDeals extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('label_id, deal_id', 'required'),
            array('label_id, deal_id', 'numerical', 'integerOnly'=>true),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, label_id, deal_id', 'safe', 'on'=>'search'),
        );
    }
     ...
     * @return LabelsInDeals the static model class
     */
