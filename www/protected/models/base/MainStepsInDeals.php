 ...
 */
class MainStepsInDeals extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('deals_id, steps_id, selected_option_id', 'required'),
            array('deals_id, steps_id, selected_option_id', 'numerical', 'integerOnly'=>true),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, deals_id, steps_id, selected_option_id', 'safe', 'on'=>'search'),
        );
    }
     ...
     * @return StepsInDeals the static model class
     */
